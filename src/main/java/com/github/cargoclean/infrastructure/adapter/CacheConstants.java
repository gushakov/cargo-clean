...
public class CacheConstants {
    ...
    public static final String CARGO_CACHE_NAME = "cargoCache";

    public static final int CARGO_CACHE_INITIAL_CAPACITY = 10;
    public static final long CARGO_CACHE_MAXIMUM_SIZE = 100L;
    public static final Duration CARGO_CACHE_EXPIRE_AFTER_WRITE_DURATION = Duration.ofHours(1L);
